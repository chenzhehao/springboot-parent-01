...
public class MQPushConsumer implements MessageListenerConcurrently {
	...
	private final DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("TestRocketMQPushConsumer1");
	...
	public void start() {
		try {
			...
			// 订阅主题
			consumer.subscribe("TopicTest", "TagTest0");
			// 注册消息监听器
	...
	public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
		int index = 0;
		try {
			LOGGER.info("MQ：消费者接收新信息:"+msgs.size());
